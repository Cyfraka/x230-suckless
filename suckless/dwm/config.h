...
static Key keys[] = {
	...
	{ MODKEY,			XK_minus,	spawn,		SHCMD("amixer --allow-boost -d 5; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,		XK_minus,	spawn,		SHCMD("amixer --allow-boost -d 15; kill -44 $(pidof dwmblocks)") },
	{ MODKEY,			XK_equal,	spawn,		SHCMD("amixer --allow-boost -i 5; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,		XK_equal,	spawn,		SHCMD("amixer --allow-boost -i 15; kill -44 $(pidof dwmblocks)") },
	...
	{ MODKEY,			XK_a,		spawn,		SHCMD("i3lock -i arch-linux-wallpaper.png") },
	...
	{ MODKEY|ShiftMask,		XK_v,		spawn,		SHCMD("{ killall xcompmgr || setsid xcompmgr & } ; xwallpaper --zoom ~/arch-linux-wallpaper.png") },
	...
	{ MODKEY,			XK_F4,		spawn,		SHCMD("i3lock -i arch-linux-wallpaper.png") },
	...
	{ 0,				XK_Print,	spawn,		SHCMD("scrot ~/pictures/%d-%m-%Y-%T.png") },
